...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <Container componentId="admin-dashboard-page">
      ...
      >
        {/* Header */}
        <Div devId="admin-dashboard-header" devName="Admin Dashboard Header" devDescription="Dashboard title and description">
          <H1 devId="admin-dashboard-title" devName="Admin Dashboard Title" devDescription="Main admin dashboard title" className="text-2xl font-bold text-gray-900">
            Admin Dashboard
          </H1>
          <P devId="admin-dashboard-description" devName="Admin Dashboard Description" devDescription="Dashboard overview description" className="text-gray-600 mt-1">
